"""
Django settings for newJobBoard project.
...
WSGI_APPLICATION = 'newJobBoard.wsgi.application'
...
AUTH_USER_MODEL = 'job_seekers.CustomUser'


# AUTHENTICATION_BACKENDS = [
#     'job_seekers.backends.EmailBackend',  # change "yourapp" to the actual app name
